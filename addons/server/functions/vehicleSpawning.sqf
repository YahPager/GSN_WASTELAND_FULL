...

{
    ...
    _vehammount = ceil (_tradius / 25);  // spawns a vehicle for every 25m radius the townmarker has, this might need tweaking!
    ...
    while {_lcounter < _vehammount && _tradius > 40} do  //ignore towns with a radius under 40 (this ignores pythos island on stratis)
    {
